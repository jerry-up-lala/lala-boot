...
import com.jerry.up.lala.boot.access.RoleAccessConstant;
...
public class RoleCtrl {
    ...
    @GetMapping("/page")
    @Api(value = "角色管理-查询", accessCodes = {RoleAccessConstant.ROLE, RoleAccessConstant.ROLE_QUERY})
    ...
    @GetMapping("/list")
    @Api(value = "公共接口-角色列表", accessCodes = {UserAccessConstant.USER_ADD, UserAccessConstant.USER_UPDATE})
    ...
    @GetMapping("/info/{id}")
    @Api(value = "角色管理-详情", accessCodes = {RoleAccessConstant.ROLE_INFO, RoleAccessConstant.ROLE_ADD, RoleAccessConstant.ROLE_UPDATE})
    ...
    @GetMapping("/verify")
    @Api(value = "角色管理-校验角色名", accessCodes = {RoleAccessConstant.ROLE_ADD, RoleAccessConstant.ROLE_UPDATE})
    ...
    @PostMapping
    @Api(value = "角色管理-新增", accessCodes = RoleAccessConstant.ROLE_ADD)
    ...
    @PutMapping("/{id}")
    @Api(value = "角色管理-编辑", accessCodes = RoleAccessConstant.ROLE_UPDATE)
