...
import com.jerry.up.lala.boot.access.UserAccessConstant;
...
public class UserCtrl {
    ...
    @GetMapping("/list")
    @Api(value = "公共接口-用户列表", accessCodes = {NoticeAccessConstant.NOTICE_ADD, NoticeAccessConstant.NOTICE_UPDATE})
    ...
    @GetMapping("/page")
    @Api(value = "用户管理-查询", accessCodes = {UserAccessConstant.USER, UserAccessConstant.USER_QUERY})
    ...
    @GetMapping("/info/{id}")
    @Api(value = "用户管理-详情", accessCodes = {UserAccessConstant.USER_INFO, UserAccessConstant.USER_UPDATE})
    ...
    @Api(value = "用户管理-复制密码", accessCodes = UserAccessConstant.USER_PASSWORD)
    ...
    @GetMapping("/verify")
    @Api(value = "用户管理-校验用户名", accessCodes = {UserAccessConstant.USER_ADD, UserAccessConstant.USER_UPDATE})
    ...
    @PostMapping
    @Api(value = "用户管理-新增", accessCodes = UserAccessConstant.USER_ADD)
    ...
    @PutMapping("/{id}")
    @Api(value = "用户管理-编辑", accessCodes = UserAccessConstant.USER_UPDATE)
    ...
    @PostMapping("/state")
    @Api(value = "用户管理-批量操作状态", accessCodes = UserAccessConstant.USER_STATE_ACTIVATION)
